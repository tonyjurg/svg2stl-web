...
the contact options on the
[maintainer's GitHub profile](https://github.com/tonyjurg). Do not include a
...
**Consequence:** A private written warning that clarifies why the behavior was
...
specified period without interaction with the people involved or those
...
communication. Violating the terms may lead to a permanent ban.
